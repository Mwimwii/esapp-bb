...
//       method: 'GET',
//       path: `/engagements/v1/engagements/paged?hapikey=${process.env.HUBSPOT_KEY}&limit=${counter.limit}&offset=${counter.offset}`
//     });
...
//             method: 'GET',
//             path: `/crm/v3/objects/contacts/${result.associations.contactIds[0]}?hapikey=${process.env.HUBSPOT_KEY}`
//           });
//           cnct = {
...
//             method: 'GET',
//             path: `/crm/v3/objects/companies/${result.associations.companyIds[0]}?hapikey=${process.env.HUBSPOT_KEY}`
//           });
//           cnct = {
...
//               hub.apiRequest({
//                 method: 'GET',
//                 path: `/filemanager/api/v3/files/${attachment.id}/signed-url?hapikey=${process.env.HUBSPOT_KEY}`
//               }).then(signedResult => {
//                 https.get(signedResult.body.url, res => {
//                   // Image will be stored at this path
//                   const path = `${process.env.TEMP_DIR}/${signedResult.body.name}.${signedResult.body.extension}`;
...
//                         rStream.close();
//                         fileRepo.save({
//                           filePath: `https://${process.env.AWS_BUCKET}.s3.${process.env.AWS_REGION}.amazonaws.com/attachments/contacts/${foldername}/${signedResult.body.name}.${signedResult.body.extension}`,
